...
import python from "../assets/pythonIcon.jpeg";
...
function Hero() {
    ...
    return(
        <>
          <div className="Hero">
              <img alt="Me next to Bookshelf" src={me} style={{ width: '1100px', height: '900px' }} />
          </div>
          <div className= "Home-Text">
            ...
            <h2>Skills</h2>
                <div className="firstThree">
                    ...
                    <img className="logo" src={python} style={{ width: '150px', height: '150px' }}/>
                ...
                <img className="logo" src={javascript} style={{ width: '150px', height: '150px' }}/>
                    ...
                    <img className="logo" src={figma} style={{ width: '150px', height: '150px' }}/>
                </div>
            </div>
